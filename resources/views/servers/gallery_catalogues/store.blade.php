...
@section('content')
@php
$url = $config['method'] == 'create' ? route('gallery.catalogue.store') : route('gallery.catalogue.update',
$galleryCatalogue->id);
@endphp
    ...
    <div class="body d-flex py-3">
        ...
        <div class="container-xxl">
            ...
            <div class="row g-3 mb-3 justify-content-center ">
                ...
                {{-- Aside --}}
                @include('servers.gallery_catalogues.blocks.aside')

                <div class="col-lg-8">
                    {{-- Main --}}
                    @include('servers.includes.content', ['model'=> $galleryCatalogue ?? []])

                    {{-- Album --}}
                    @include('servers.includes.album')

                    {{-- Seo --}}
                    @include('servers.includes.seo', ['model'=> $galleryCatalogue ?? []])
                </div>
            </div><!-- Row end  -->
