            ...
            <div class="border-0 mb-4">
                <div
                    ...
                    <div class="col-auto d-flex w-sm-100">
                        <a href="{{route('post.create')}}" class="btn btn-primary btn-set-task w-sm-100">
        ...
        <div class="row clearfix g-3">
            <div class="col-sm-12">
                ...
                <div class="card mb-2">
                    <div class="card-body ">
                        {{-- Toolbox --}}
                        @include('servers.includes.toolbox', ['model' =>'Post'] )
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        @include('servers.posts.blocks.table', ['modelName' =>'Post'])
                        {{-- Pagination --}}
