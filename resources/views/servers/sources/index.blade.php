            ...
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    ...
                    <div class="col-auto d-flex w-sm-100">
                        <a href="{{route('source.create')}}" class="btn btn-primary btn-set-task w-sm-100">
        ...
        <div class="row clearfix g-3">
            <div class="col-sm-12">
                ...
                <div class="card mb-2">
                    <div class="card-body ">
                        {{-- Toolbox --}}
                        @include('servers.includes.toolbox', ['model' =>'Source'] )
                    </div>
                </div>
                ...
                <div class="card mb-2">
                    <div class="card-body ">
                        {{-- Filter --}}
                        @include('servers.sources.blocks.filter' )
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        @include('servers.sources.blocks.table', ['modelName' =>'Source'])
                        {{-- Pagination --}}
