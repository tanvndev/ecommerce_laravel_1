...
@section('content')
@php
$url = $config['method'] == 'create' ? route('customer.catalogue.store') : route('customer.catalogue.update',
                ...
                <div class="card mb-3 card-create">
                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-center">
                            <div class="col-md-6">
                                {!! Form::label('name', __('messages.customerCatalogue.table.name'), ['class' =>
                                'form-label']) !!}<span class="text-danger">(*)</span>
                                {!! Form::text('name', old('name', $customerCatalogue->name ?? ''), ['class' =>
                                'form-control']) !!}
                            </div>
                            <div class="col-md-6">
                                {!! Form::label('description', __('messages.description'), ['class' => 'form-label'])
                                !!}
                                {!! Form::text('description', old('description', $customerCatalogue->description ?? ''),
                                ['class' => 'form-control']) !!}
                            </div>
